...
export interface paths {
  ...
  "/items/band": {
    /**
     * List Items
     * @description List the band items.
     */
    get: operations["readItemsBand"];
    /**
     * Create an Item
     * @description Create a new band item.
     */
    post: operations["createItemsBand"];
    /**
     * Delete Multiple Items
     * @description Delete multiple existing band items.
     */
    delete: operations["deleteItemsBand"];
    /**
     * Update Multiple Items
     * @description Update multiple band items at the same time.
     */
    patch: operations["updateItemsBand"];
  };
  "/items/band/{id}": {
    /**
     * Retrieve an Item
     * @description Retrieve a single band item by unique identifier.
     */
    get: operations["readSingleItemsBand"];
    /**
     * Delete an Item
     * @description Delete an existing band item.
     */
    delete: operations["deleteSingleItemsBand"];
    /**
     * Update an Item
     * @description Update an existing band item.
     */
    patch: operations["updateSingleItemsBand"];
  };
  "/items/release": {
    /**
     * List Items
     * @description List the release items.
     */
    get: operations["readItemsRelease"];
    /**
     * Create an Item
     * @description Create a new release item.
     */
    post: operations["createItemsRelease"];
    /**
     * Delete Multiple Items
     * @description Delete multiple existing release items.
     */
    delete: operations["deleteItemsRelease"];
    /**
     * Update Multiple Items
     * @description Update multiple release items at the same time.
     */
    patch: operations["updateItemsRelease"];
  };
  "/items/release/{id}": {
    /**
     * Retrieve an Item
     * @description Retrieve a single release item by unique identifier.
     */
    get: operations["readSingleItemsRelease"];
    /**
     * Delete an Item
     * @description Delete an existing release item.
     */
    delete: operations["deleteSingleItemsRelease"];
    /**
     * Update an Item
     * @description Update an existing release item.
     */
    patch: operations["updateSingleItemsRelease"];
  };
}
...
export interface components {
  schemas: {
    ...
    ItemsBand: {
      ...
      date_updated?: string | null;
      name?: string | null;
      releases?: ((number | components["schemas"]["ItemsRelease"])[]) | null;
    };
    ItemsRelease: {
      id?: number;
      status?: string;
      ...
      band?: number | components["schemas"]["ItemsBand"] | null;
    };
  };
  responses: {
...
export interface operations {
  ...
  readItemsBand: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsBand"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  createItemsBand: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsBand"][] | components["schemas"]["ItemsBand"];
      };
    };
    responses: {
      /** @description Successful request */
  ...
  updateSingleItemsBand: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsBand"];
      };
    };
    responses: {
      /** @description Successful request */
  ...
  readItemsRelease: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsRelease"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  createItemsRelease: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsRelease"][] | components["schemas"]["ItemsRelease"];
      };
    };
    responses: {
      /** @description Successful request */
  ...
  updateSingleItemsRelease: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsRelease"];
      };
    };
    responses: {
      /** @description Successful request */
...
export type ApiCollections = {
  band: components["schemas"]["ItemsBand"][];
  release: components["schemas"]["ItemsRelease"][];
};
